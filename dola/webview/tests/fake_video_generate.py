"""Test double for free_protocol video generate (job_worker unit tests)."""
...
def main() -> int:
    # Accept both:
    #   python fake_video_generate.py video generate --out ...
    #   python fake_video_generate.py --out ...
    ...
    print(json.dumps({"accepted": True, "file": str(video), "mode": "http-external-submit"}))
    return 0
